...
export default function UserPopover({
    ...
    return (
        <motion.div
            ...
            className="absolute right-0 top-20 w-full max-w-[200px] rounded-xl bg-white px-5 py-3"
        >
            <div className="flex flex-col">
                ...
                <button
                    onClick={() => logout()}
                    className="flex items-center gap-2 bg-red/15 px-2 py-1 text-start text-red"
                >
                    <Icon
                        id="icon-exit"
                        w={20}
